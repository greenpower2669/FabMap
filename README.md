...
## 0.5.2 — Titres plus sobres et icônes incrustées
Les gros bandeaux de 0.5.1 sont remplacés par des titres bicolores avec ombre douce (mode guidé et Vallée). Chaque icône est présentée sur une pastille translucide ; le découpage des planches en petites icônes PNG met les coins au transparent sans modifier les PNG maîtres. Les icônes personnelles nouvellement ajoutées sont enregistrées en PNG 256px avec alpha ; les précédents JPEG restent pris en charge. Les sauvegardes complètes et paquets de bulles acceptent les deux formats d'images. Aucune modification de la procédure TV ou des données personnelles.

## 0.6.0 — commandes de chaque bulle
Chaque bulle est représentée par sa photo, sinon son pictogramme, sinon un symbole neutre. Au-dessous, le crayon arc-en-ciel permet sa couleur et ses évocations personnelles, le + lui ajoute directement une fille, et l'engrenage ouvre SES options (image, édition, étapes, liens, exporter cette bulle avec ses filles et fichiers liés, importer des bulles ici). L'engrenage GÉNÉRAL de l'accueil donne sauvegarde/restauration complète. Couleur choisie par hexagones nommés ou par #RRGGBB, sentiments et évocations stockés séparément sans remplacer son sens normal. JPG/PNG de représentation et icônes privées circulent dans les archives. La carte masque les commandes si trop dézoomée ; le mode guidé les conserve.
